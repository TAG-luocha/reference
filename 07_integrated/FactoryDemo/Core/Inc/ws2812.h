...
#define CODE_ONE_DUTY 60
#define CODE_ZERO_DUTY 30
// #define CODE_ONE_DUTY 66 - 15
// #define CODE_ZERO_DUTY 21 + 15
...
// 彩虹效果
void rainbow_effect(uint16_t steps, uint16_t delay_ms);
